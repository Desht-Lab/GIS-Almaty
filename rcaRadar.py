...
selected_columns = st.multiselect('Select categories to include in the radar chart:', modified_column_names, modified_column_names)
...
def create_radar_chart(rca_df, selected_columns):
...
create_radar_chart(rca_df, selected_columns)
